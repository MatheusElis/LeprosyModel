...
IncidenceMBV00T50 <- plot_ly( x=T0m$Time, y=T0m$NewInfectiousMB ,name = '0 Months',mode = 'lines',type = 'scatter' ,showlegend = F) %>%
  add_trace(y= T3m$NewInfectiousMB, name = '3 Months', mode = 'scatter',showlegend = F) %>%
  add_trace(y= T6m$NewInfectiousMB, name = '6 Months', mode = 'scatter',showlegend = F) %>%
  add_trace(y= T12m$NewInfectiousMB, name = '12 Months', mode = 'scatter',showlegend = F) %>%
  add_trace(y= T24m$NewInfectiousMB, name = '24 Months', mode = 'scatter',showlegend = F) %>%
  add_trace(y= T36m$NewInfectiousMB, name = '36 Months', mode = 'scatter',showlegend = F) %>%
  layout(
    colorway = c('#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b'),
    legend = list(title=list(text='<b> Identification Time </b>'),bgcolor="#E2E2E2"),
    xaxis = list(title = 'Time (Years)', rangemode = 'tozero',  titlefont = f),
...
IncidenceMBV00T75 <- plot_ly( x=T0m$Time, y=T0m$NewInfectiousMB ,name = '0 Months',mode = 'lines',type = 'scatter' ,showlegend = F) %>%
  add_trace(y= T3m$NewInfectiousMB, name = '3 Months', mode = 'lines',showlegend = F) %>%
  add_trace(y= T6m$NewInfectiousMB, name = '6 Months', mode = 'lines',showlegend = F) %>%
  add_trace(y= T12m$NewInfectiousMB, name = '12 Months', mode = 'lines',showlegend = F) %>%
  add_trace(y= T24m$NewInfectiousMB, name = '24 Months', mode = 'lines',showlegend = F) %>%
  add_trace(y= T36m$NewInfectiousMB, name = '36 Months', mode = 'lines',showlegend = F) %>%
  layout(
    colorway = c('#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b'),
    legend = list(title=list(text='<b> Identification Time </b>'),bgcolor="#E2E2E2"),
    xaxis = list(title = 'Time (Years)', rangemode = 'tozero',  titlefont = f),
...
Vaccine0 <- subplot(IncidenceMBV00T25,IncidenceMBV00T50,IncidenceMBV00T75,IncidenceMBV00T95,margin = 0.1,nrows = 2,titleY = T,titleX = T,shareY = F,shareX = F)
Vaccine0 <- Vaccine0 %>% layout(
  title = '<b>Leprosy Incidence MB</b>',
  annotations = list(
...
orca(Vaccine0,"leprosyIncidenceMBV0.png",width = 1200,height = 960,mathjax = T)
#htmlwidgets::saveWidget(Vaccine0, "leprosyIncidenceMBV0.html",selfcontained = FALSE)
#----------------------------------------------------------------------------------------------
#----------------------------------------------------------------------------------------------
...
IncidenceMBV50T25 <- plot_ly( x=T0m$Time, y=T0m$NewInfectiousMB ,name = '0 Months',mode = 'lines',type = 'scatter',showlegend = T ) %>%
  add_trace(y= T3m$NewInfectiousMB, name = '3 Months', mode = 'lines',showlegend = T) %>%
  add_trace(y= T6m$NewInfectiousMB, name = '6 Months', mode = 'lines',showlegend = T) %>%
  add_trace(y= T12m$NewInfectiousMB, name = '12 Months', mode = 'lines',showlegend = T) %>%
  add_trace(y= T24m$NewInfectiousMB, name = '24 Months', mode = 'lines',showlegend = T) %>%
  add_trace(y= T36m$NewInfectiousMB, name = '36 Months', mode = 'lines',showlegend = T) %>%
  layout(
    colorway = c('#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b'),
    legend = list(title=list(text='<b> Identification Time </b>'),bgcolor="#E2E2E2"),
    xaxis = list(title = 'Time (Years)', rangemode = 'tozero',  titlefont = f),
...
Vaccine50 <- subplot(IncidenceMBV50T25,IncidenceMBV50T50,IncidenceMBV50T75,IncidenceMBV50T95,margin = 0.1,nrows = 2,titleY = T,titleX = T,shareY = F,shareX = F)
...
Vaccine50
# orca(Vaccine0,"leprosyPrevalenceV0.eps",width = 900,height = 800)
orca(Vaccine50,"leprosyIncidenceMBV50.png",width = 1200,height = 960,mathjax = T)
#htmlwidgets::saveWidget(Vaccine50, "leprosyIncidenceMBV50.html",selfcontained = FALSE)
...
Vaccine99 <- subplot(IncidenceMBV99T25,IncidenceMBV99T50,IncidenceMBV99T75,IncidenceMBV99T95,margin = 0.1,nrows = 2,titleY = T,titleX = T,shareY = F,shareX = F)
...
Vaccine99
# orca(Vaccine0,"leprosyPrevalenceV0.eps",width = 900,height = 800)
orca(Vaccine99,"leprosyIncidenceMBV99.png",width = 1200,height = 960,mathjax = T)
#htmlwidgets::saveWidget(Vaccine99, "leprosyIncidenceMBV99.html",selfcontained = FALSE)

system("mkdir imagens/png/leprosyincidenceMB4x4")
system("mkdir imagens/html/leprosyincidenceMB4x4")

system("mv *.png imagens/png/leprosyincidenceMB4x4")
system("mv *.html imagens/html/leprosyincidenceMB4x4")
