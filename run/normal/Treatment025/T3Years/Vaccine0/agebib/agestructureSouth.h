void agestructureSouth() // for North
{
  ProbBirthAge[1]  = 6.5e-2; // 0–4 years
  ProbBirthAge[2]  = 7.1e-2; // 5–9 years
  ProbBirthAge[3]  = 8.4e-2; // 10–14
  ProbBirthAge[4]  = 8.5e-2; // 15–19
  ProbBirthAge[5]  = 8.5e-2; // 20–24
  ProbBirthAge[6]  = 8.6e-2; // 25–29
  ProbBirthAge[7]  = 7.9e-2; // 30–34
  ProbBirthAge[8]  = 7.1e-2; // 35–39
  ProbBirthAge[9]  = 7.2e-2; // 40–44
  ProbBirthAge[10] = 7.0e-2; // 45–49
  ProbBirthAge[11] = 6.0e-2; // 50–54
  ProbBirthAge[12] = 5.0e-2; // 55–59
  ProbBirthAge[13] = 3.9e-2; // 60–64
  ProbBirthAge[14] = 2.8e-2; // 65–69
  ProbBirthAge[15] = 2.2e-2; // 70–74
