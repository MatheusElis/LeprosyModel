void agestructureSouthEast() // for North
{
  ProbBirthAge[1]  = 6.5e-2; // 0–4 years
  ProbBirthAge[2]  = 7.1e-2; // 5–9 years
  ProbBirthAge[3]  = 8.3e-2; // 10–14
  ProbBirthAge[4]  = 8.2e-2; // 15–19
  ProbBirthAge[5]  = 8.7e-2; // 20–24
  ProbBirthAge[6]  = 8.9e-2; // 25–29
  ProbBirthAge[7]  = 8.4e-2; // 30–34
  ProbBirthAge[8]  = 7.6e-2; // 35–39
  ProbBirthAge[9]  = 7.2e-2; // 40–44
  ProbBirthAge[10] = 6.7e-2; // 45–49
  ProbBirthAge[11] = 5.9e-2; // 50–54
  ProbBirthAge[12] = 4.9e-2; // 55–59
  ProbBirthAge[13] = 3.7e-2; // 60–64
  ProbBirthAge[14] = 2.7e-2; // 65–69
  ProbBirthAge[15] = 2.1e-2; // 70–74
  ProbBirthAge[16] = 1.5e-2; // 75–79
  ProbBirthAge[17] = 1.0e-2; // 80–84
  ProbBirthAge[18] = 0.5e-2; // 85–89
  ProbBirthAge[19] = 0.1e-2; // 90+
