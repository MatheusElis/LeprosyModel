void agestructureNorthEast() // for North
{
  ProbBirthAge[1]  = 7.0e-2; // 0–4 years
  ProbBirthAge[2]  = 8.7e-2; // 5–9 years
  ProbBirthAge[3]  = 9.9e-2; // 10–14
  ProbBirthAge[4]  = 9.7e-2; // 15–19
  ProbBirthAge[5]  = 9.5e-2; // 20–24
  ProbBirthAge[6]  = 9.0e-2; // 25–29
  ProbBirthAge[7]  = 7.0e-2; // 30–34
  ProbBirthAge[8]  = 6.9e-2; // 35–39
  ProbBirthAge[9]  = 6.3e-2; // 40–44
  ProbBirthAge[10] = 5.5e-2; // 45–49
  ProbBirthAge[11] = 4.5e-2; // 50–54
  ProbBirthAge[12] = 3.7e-2; // 55–59
  ProbBirthAge[13] = 3.1e-2; // 60–64
  ProbBirthAge[14] = 2.4e-2; // 65–69
  ProbBirthAge[15] = 1.9e-2; // 70–74
  ProbBirthAge[16] = 1.2e-2; // 75–79
  ProbBirthAge[17] = 0.9e-2; // 80–84
  ProbBirthAge[18] = 0.5e-2; // 85–89
  ProbBirthAge[19] = 2.3e-2; // 90+
