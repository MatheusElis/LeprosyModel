void agestructureNorth() // for North
{
  ProbBirthAge[1]  = 9.8e-2; // 0–4 years
  ProbBirthAge[2]  = 10.4e-2; // 5–9 years
  ProbBirthAge[3]  = 10.0e-2; // 10–14
  ProbBirthAge[4]  = 10.3e-2; // 15–19
  ProbBirthAge[5]  = 9.8e-2; // 20–24
  ProbBirthAge[6]  = 9.3e-2; // 25–29
  ProbBirthAge[7]  = 8.2e-2; // 30–34
  ProbBirthAge[8]  = 6.8e-2; // 35–39
  ProbBirthAge[9]  = 5.8e-2; // 40–44
  ProbBirthAge[10] = 4.7e-2; // 45–49
  ProbBirthAge[11] = 3.9e-2; // 50–54
  ProbBirthAge[12] = 3.0e-2; // 55–59
  ProbBirthAge[13] = 2.2e-2; // 60–64
  ProbBirthAge[14] = 1.7e-2; // 65–69
  ProbBirthAge[15] = 1.2e-2; // 70–74
  ProbBirthAge[16] = 0.8e-2; // 75–79
  ProbBirthAge[17] = 0.5e-2; // 80–84
  ProbBirthAge[18] = 0.2e-2; // 85–89
  ProbBirthAge[19] = 1.4e-2; // 90+
