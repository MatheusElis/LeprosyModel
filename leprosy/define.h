/* Leprosy REAL states */
//--------------------------------------------------------------------------------------------
#define tratamento 0.5 
#define ImmunityVaccine 0.99         /* imunnity due to BCG */
#define TimeIdentificationMax 0*365      /* Maximum prob. to identify a new case in months */
//--------------------------------------------------------------------------------------------
...
#define MAXSIM 15              /* Number of simulations to evaluate averages */
